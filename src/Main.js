        ...
        <section className="row" style={{ fontFamily: 'courier', padding: 20, maxWidth: 400, margin: '0 auto', border: '0x solid'}}>
          ...
          <div style={{ fontSize: 28 }}>
            ...
            <section style={{ paddingTop: 10 }}>
              <div style={{ fontSize: 16, paddingBottom: 15 }}><span style={styles.byte}>Byte</span> was designed and built at <a target="_new" style={styles.hyperlink} href="https://facebook.com/hubsycafe">hubsy</a> in Paris, France where coffee makes all things possible.</div>
